...
import static com.hydra.framework.kvo.core.helper.EventHelper.getExcludeSystemFields;
import static com.hydra.framework.kvo.core.helper.EventHelper.getExcludeSystemMethods;

import android.util.Log;

import androidx.annotation.NonNull;

import com.hydra.framework.kvo.KvoFieldAnnotation;
import com.hydra.framework.kvo.KvoHashSet;
import com.hydra.framework.kvo.KvoMethodAnnotation;
import com.hydra.framework.kvo.KvoSource;
import com.hydra.framework.kvo.core.EventAction;
import com.hydra.framework.kvo.list.KvoList;
import com.hydra.framework.kvo.map.KvoHashMap;
    ...
    private static ArrayList<KvoMethodNode> getReceiverClassKvoMethodNodes(@NonNull KvoSource source,
        ...
        for (Method method : methods) {
            ...
            if (preMethod != null && preMethod.getName().equals(method.getName())) {
                Log.d(KVO_LOG_TAG, "getKvoMethods find method override, subMethod: " +
        ...
        for (Field field : fields) {
            ...
            if (annotation != null) {
                ...
                if (preField == null) {
                    ...
                    Log.w(KVO_LOG_TAG, "two field in sub class and superclass has the same annotation " +
                            "name in" +
