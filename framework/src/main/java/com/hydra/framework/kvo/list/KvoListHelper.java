...
import static com.hydra.framework.kvo.list.KvoListHelper.KvoListChangeType.KvoEventArg_Type_Insert;
import static com.hydra.framework.kvo.list.KvoListHelper.KvoListChangeType.KvoEventArg_Type_Reload;
import static com.hydra.framework.kvo.list.KvoListHelper.KvoListChangeType.KvoEventArg_Type_Remove;
...
public class KvoListHelper {
    ...
    public static <T> void notifyRangeReplace(KvoSource source, String name, List<T> list, int location, int length) {
        notifyKvoArrayChange(source, name, list, KvoListChangeType.KvoEventArg_Type_Replace, new NSRange(location, length));
    }
